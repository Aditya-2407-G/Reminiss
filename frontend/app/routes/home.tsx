...
import { 
  ArrowRight, BookOpen, Users, Image, Shield, 
  Sparkles, GraduationCap, Heart, Camera, Share2 
} from "lucide-react"
...
export default function Home() {
  ...
  return (
<div className="flex min-h-screen flex-col bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-violet-200 via-violet-50 to-background dark:from-violet-950/20 dark:via-background dark:to-background">
        ...
        <div className="container max-w-6xl px-6 mx-auto flex h-20 items-center justify-between">
          ...
          <div className="flex gap-6 mx-4 items-center">
            <nav className="hidden md:flex gap-6">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>Explore our amazing features</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            <div className="flex gap-3">
              ...
              <Link to="/register" className={cn(buttonVariants({ size: "sm" }), "relative group overflow-hidden")}>
          ...
          <div className="container max-w-6xl px-6 mx-auto flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-center md:text-left md:pr-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link to="/register" className="group relative px-6 py-3 rounded-lg overflow-hidden bg-background shadow-md hover:shadow-lg">
            ...
            <div className="flex-1 relative">
              <div className="absolute -inset-1.5 rounded-lg bg-gradient-to-r from-violet-500/30 via-indigo-500/20 to-purple-500/10 blur-xl opacity-70 dark:from-violet-700/30 dark:via-indigo-700/20 dark:to-purple-700/10 animate-pulse"></div> 
              <Card className="relative overflow-hidden border-violet-100 dark:border-violet-900/50 shadow-xl bg-background/95 dark:bg-background/80">
                      ...
                      {[
                        ...
                        <CarouselItem key={index}>
                          <div className="h-full w-full overflow-hidden rounded-lg">
                            <img src={image} alt={`College memories ${index+1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-700 ease-in-out" />
                          </div>
                        </CarouselItem>
                      ))}
                    </CarouselContent>
        ...
        <section className="py-16 relative">
          ...
          <div className="container max-w-6xl px-6 mx-auto relative z-10">
            <div className="text-center mb-12">
              <Badge variant="outline" className="mb-4 px-3 py-1 text-sm bg-violet-500/10 text-violet-700 dark:text-violet-300 border-violet-200 dark:border-violet-800">
                Features
              </Badge>
              <h2 className="text-3xl font-bold mb-4">Everything you need to preserve memories</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto dark:text-muted-foreground/90">
                Our platform provides all the tools you need to create a beautiful digital yearbook
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                {
                  icon: <GraduationCap className="h-10 w-10 text-violet-500 dark:text-violet-400" />,
                ...
                <Card key={index} className="relative overflow-hidden border-none bg-gradient-to-br from-background to-violet-50/50 dark:from-background dark:to-violet-950/20 hover:shadow-md transition-all group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Link to="/register" className="group relative px-8 py-3 rounded-lg overflow-hidden bg-background shadow-md hover:shadow-lg">
                        <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-indigo-500 transition-all duration-300 ease-out group-hover:scale-105"></div>
      ...
      <footer className="border-t py-12 bg-gradient-to-b from-muted/30 to-muted/50 dark:from-muted/10 dark:to-muted/20 dark:border-border/40">
        {/* Keep the footer similar but modernized slightly */}
        <div className="container max-w-6xl px-6 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="relative group">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
                  <div className="h-8 w-8 rounded-full bg-background flex items-center justify-center relative">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-500 font-bold text-sm">R</span>
                  </div>
                </div>
              ...
              <div className="flex gap-4 mt-4">
                <Link to="#" className="text-muted-foreground hover:text-violet-500 dark:hover:text-violet-400">
                  <span className="sr-only">Twitter</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </Link>
                <Link to="#" className="text-muted-foreground hover:text-indigo-500 dark:hover:text-indigo-400">
                ...
                <Link to="#" className="text-muted-foreground hover:text-purple-500 dark:hover:text-purple-400">
                ...
                <Link to="#" className="text-muted-foreground hover:text-pink-500 dark:hover:text-pink-400">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="#" className="text-muted-foreground hover:text-violet-500 dark:text-muted-foreground/90 dark:hover:text-violet-400 transition-colors">
                    Features
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="#" className="text-muted-foreground hover:text-indigo-500 dark:text-muted-foreground/90 dark:hover:text-indigo-400 transition-colors">
                    About
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-violet-100 dark:border-violet-900/50 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center gap-2 mt-4 md:mt-0">
              <span className="text-s text-muted-foreground dark:text-muted-foreground/70">Made with</span>
              <Heart className="h-3 w-3 text-red-500 fill-red-500" />
              <span className="text-s text-muted-foreground dark:text-muted-foreground/70">and the wisdom of midnight snacks</span>
            </div>
          </div>
        </div>
      </footer>
